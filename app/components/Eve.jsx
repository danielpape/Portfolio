                    ...
                    <div className="row">
                        <div className="col-sm-12">
                          <div className="appDescriptionBody">
                            ...
                            <p>This was the idea behind Eve Alarm. Most people can't choose that time at which they wake up, but they can choose when to go to bed. Eve Alarm is an alarm app that uses this thinking to flip a traditional alarm on its head: <em>a bed time alarm</em> rather than a wake time alarm.</p>
                      </div>
                        </div>
                    </div>
                </div>
